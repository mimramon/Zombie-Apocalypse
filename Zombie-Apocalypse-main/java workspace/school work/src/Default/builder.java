public class builder extends survivor
{
	...
	public void idle(int partyPosition)
	{
		...
		{
			main.windowOutput("4) Build a house");
    			if(main.settlement.wood >= 20 && !main.settlement.workshop)
    			{
    				...
    				switch (Integer.parseInt(userInput)) 
    				{
    					...
    					case 4:
							...
							main.windowOutput("You have built another house. You now have " + main.settlement.houses + " houses.");
    						break;
    					case 5:
							main.settlement.workshop = true;
							main.settlement.wood = main.settlement.wood - 20;
							main.windowOutput("You have built the workshop!");
    						break;
    					default:
    						break;
					}
